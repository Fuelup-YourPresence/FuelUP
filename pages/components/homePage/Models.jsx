    ...
    <Box display='flex' flexDirection='column'>
      ...
      <Box className={classes.infoContainer}>
        <Box className={classes.infoRow}>
          <Typography variant='h3' className={classes.number}>{data.id}</Typography>
          <Typography variant='h6' className={classes.title}>{data.stepname}</Typography>
        </Box>
        <Box className={classes.infodescr}>
          <Typography className={classes.process}>{data.process}</Typography>
        </Box>
